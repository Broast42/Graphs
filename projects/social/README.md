...
500 times. The formulla for finding the number of friendships is:
    number of users * average friendships devided by 2


2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?

According to the tests I created to evaluate this question, assuming I understood this correctly, on average its about 99 percent of other users in a given users extended network. And on average the average degree of seperation is around 5 to 6 people
